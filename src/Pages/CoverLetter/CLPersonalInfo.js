                ...
                <form action="" className='p-3 ' >
                    <div className=' mb-3 '>
                        <input type="text" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} placeholder="Your Name"
                            class="input input-bordered input-primary w-full max-w-lg peer dark:text-black" required />
                    ...
                    <div className='mb-3'>
                        <input type="text" value={formData.designation} onChange={(e) => setFormData({ ...formData, designation: e.target.value })} placeholder="Your Designation" class="input input-bordered input-primary w-full max-w-lg peer dark:text-black" required />
                        <p class="invisible peer-invalid:visible text-red-700 font-light text-left">
                    ...
                    })} placeholder="Address" class="input input-bordered p-3  input-primary w-full max-w-lg peer dark:text-black" required />
                    ...
                    <div className='flex gap-2 mb-3 '>
                        <div>
                            ...
                            })} placeholder="City" class="input input-bordered p-3 input-primary w-full max-w-lg peer dark:text-black" required />
                            <p class="invisible peer-invalid:visible text-red-700 font-light text-left">
                        ...
                        <div>
                            <input type="email" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} placeholder="E-mail"
                                class="input input-bordered input-primary w-full max-w-xs peer dark:text-black" required />
                            <p class="invisible peer-invalid:visible text-red-700 font-light text-left">
                    ...
                    <div className='flex gap-2 mb-3 '>
                        <div>
                            <input type="number" value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })}
                                placeholder="Phone Number" class="input input-bordered input-primary w-full max-w-xs peer dark:text-black" required />
                        ...
                        <div>
                            <input type="text" value={formData.linkedin} onChange={(e) => setFormData({ ...formData, linkedin: e.target.value })}
                                placeholder="www.linkedin.com" class="input input-bordered input-primary w-full max-w-xs peer dark:text-black" required />
                            <small class="invisible peer-invalid:visible text-red-700 font-light text-left">
