        ...
        <div className='mt-28 mb-16 m-10'>
            <div className='flex '>
                <div class=" rounded-xl bg-gray-200 ">
                    <div class="col-start-1 col-end-12 ... bg-gray-200 rounded-xl w-96">
                        <ul class="steps  p-3 place-items-center">
                    ...
                    <div className='w-96'>
                        <form action="" className='p-3'>
                            ...
                            <div className='flex flex-col-reverse  gap-2 mb-3 '>
                                ...
                                <input type="text" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} placeholder="NAME" class="input input-bordered input-secondary w-auto max-w-xs" />
