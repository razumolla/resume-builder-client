                            ...
                            <form action="" className='p-3'>
                                <div className='flex flex-col-reverse  gap-2 mb-3 '>
                                    ...
                                    <textarea value={formData.professionalCareer} onChange={(e) => setFormData({ ...formData, professionalCareer: e.target.value })}
                                        className=' p-2 input input-border input-primary w-72 lg:w-80 md:w-80 peer' required placeholder='Professional Career' name="Description"  ></textarea>
                                ...
                                <div className='flex flex-col-reverse  gap-2 mb-3 '>
                                    ...
                                    className=' p-2 input input-border input-primary peer w-72 lg:w-80 md:w-80'
