                ...
                <div className='h-auto w-full md:h-80'>
                    ...
                    <div class="card-body flex flex-col  md:flex-row justify-start items-center bg-base-200 rounded-lg shadow-lg m-5 h-56  md:h-24 gap-8 dark:bg-cyan-900">
                        ...
                        <div className='h-20 text-justify'>
                            ...
                            <p className='text-sm md:text-md'>Our resume builder application is very easy to use.You can create your resume at very ease</p>
                    ...
                    <div class="card-body flex flex-col  md:flex-row justify-start items-center bg-base-200 rounded-lg shadow-lg m-5 h-56  md:h-24 gap-8 dark:bg-cyan-900">
                        ...
                        <div className='h-20 text-justify '>
                            ...
                            <p className='text-sm md:text-md'>Our resume builder built resume for you in step by step </p>
                        </div>
                    </div>
                    ...
                    <div class="card-body flex flex-col  md:flex-row justify-start items-center bg-base-200 rounded-lg shadow-lg m-5 h-56  md:h-24 gap-8 dark:bg-cyan-900">
                        ...
                        <div className='h-20 text-justify'>
                            ...
                            <p className='text-sm md:text-md'>User can create resume and can see how it is in a real time.</p>
                        </div>
                    </div>
                </div>
