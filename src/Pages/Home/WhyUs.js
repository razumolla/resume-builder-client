    ...
    return (
        <div className='my-20'>
            <div className='grid grid-clos-1 lg:grid-cols-2 gap-5'>
                <div className='h-80'>
                    ...
                    <div class="card-body flex flex-row justify-start items-center bg-base-200 rounded-lg shadow-2xl m-5 h-24 gap-8 dark:bg-cyan-900">
                        ...
                        <div className='h-20 text-justify '>
                            <p className='font-bold text-primary text-lg'>Easy Online resume builder</p>
                    ...
                    <div class="card-body flex flex-row justify-start items-center bg-base-200 rounded-lg shadow-2xl m-5 h-24 dark:bg-cyan-900">
                        ...
                        <div className='h-20 text-justify '>
                            <p className='font-bold text-primary text-lg'>Step By Step Expert Tips</p>
                    ...
                    <div class="card-body flex flex-row justify-start items-center bg-base-200 rounded-lg shadow-2xl m-5 h-24 dark:bg-cyan-900">
                        ...
                        <div className='h-20 text-justify'>
                            <p className='font-bold text-primary text-lg'>Edit Your zResume In Real Time</p>
                ...
                <div className=''>
                    <div className='bg-base-200 rounded-lg shadow-2xl h-80 m-5 dark:bg-cyan-900'>
                        <h1 className='font-bold text-center text-primary text-3xl pt-20 mb-5'>Why Choose Our Platform?</h1>
