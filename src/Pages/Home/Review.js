...
const Review = () => {
    return (
        <div className='my-20'>
            <h1 className='text-3xl text-center font-bold text-primary mb-10'>Your Success, Our Inspiration</h1>



            <div className='grid sm:grid-cols-1 lg:grid-cols-3 my-5 gap-5'>
                <div className="card lg:lg-w-full bg-blue-300 shadow-xl dark:bg-cyan-900">
