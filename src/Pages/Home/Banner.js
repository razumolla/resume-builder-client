            ...
            <div className="hero ">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className='text-left text-white mr-32'>
                        <h1 className="lg:text-6xl lg:text-left sm:text-center sm:text-4xl font-bold animate__animated animate__fadeInUp animate__delay-faster text-white">Create a Professional
