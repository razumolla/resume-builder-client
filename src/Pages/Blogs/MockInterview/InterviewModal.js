            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box relative">
                    ...
                    <form onSubmit={interviewAppoint} className='grid grid-cols-1 justify-items-center gap-5 mt-3'>
                        ...
                        <input type="number" name='phone' placeholder="Your Phone no." className="input input-bordered w-full max-w-xs" />

                        <input type="submit" placeholder="Type here" className="btn btn-primary w-full max-w-xs" />
                    </form>
                </div>
            </div>
        </div>
