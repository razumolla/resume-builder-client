...
const InterviewQuesAnsCSS = () => {
    return (
        <div className='mt-10  '>
            ...
            <div className='dark:bg-cyan-900 lg:mb-20 mb-14  bg-gray-300  lg:ml-16 lg:mr-16 sm:m-0 sm:ml-0 sm:mr-0'>

                <h1 className='p-5 text-2xl md:text-3xl lg:3xl  font-bold'> Most Common <span className='text-primary'>CSS</span> Interview Questions and Answers</h1>

                <div className='lg:flex '>
                    <div className='m-auto ml-20 mb-4 mt-4'>
                        <img src={css} className='w-10/12 lg:ml-10  lg:mt-28 ' alt="" />
                    </div>
