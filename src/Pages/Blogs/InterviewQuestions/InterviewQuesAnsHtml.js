...
const InterviewQuesAnsHtml = () => {
    return (
        <div className='mt-10 mb-96 '>
            ...
            <div className='bg-gray-300   lg:m-10 lg:ml-16 lg:mr-16 sm:m-0 sm:ml-0 sm:mr-0 dark:bg-cyan-900'>
                ...
                <div className='lg:flex justify-center sm:flex-cols'>
                    ...
                    <div className='lg:m-10 sm:m-8 lg:p-5 sm:p-4 lg:w-1/2 sm:w-0'>
                        <div tabindex="0" class="collapse collapse-plus border   border-base-300 bg-base-100 rounded-box overflow-hidden dark:bg-cyan-900">
