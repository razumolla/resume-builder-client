...
const SignUp = () => {
  ...
  return (
    <div className="reg">
      <h1 className="py-7 sm:text-3xl font-extrabold text-primary lg:text-3xl bg-clip-text bg-secondary mx-auto">
        WELCOME TO REGISTRATION
          ...
          <div className="flex justify-center items-center mt-5 ">
            <div className="card w-96 bg-white shadow-xl mb-5  login_div dark:bg-cyan-900 ">
                  ...
                  <div className="form-control w-full max-w-xs">
                    ...
                    <label className="label">
                      {errors.name?.type === "required" && (
                        <span className="label-text-alt text-red-500 dark:text-black">
                          {errors.name.message}
                        </span>
                      )}
                    </label>
