                ...
                <div className="navbar-end px-5">
                    <ul className="flex">
                        <li>
                            {
                                user ?
                                    <button onClick={logout} className="btn btn-ghost hover:bg-primary text-black ">Sign Out</button>
                                    :
                                    <Link to="/login" className=" btn btn-ghost hover:bg-primary text-black">Login</Link>
                            }
                        </li>
                    </ul>
                </div>
