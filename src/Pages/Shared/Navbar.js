...
const Navbar = () => {
    ...
    return (
        <div class="navbar bg-base-200 top-0 fixed z-50">
            <div class="navbar bg-base-100 top-0 fixed z-50 shadow-lg">
                <div class="navbar-start">
                    <div class="dropdown">
                        ...
                        <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-primary rounded-box w-52 text-secondary text-white">
                            {menuItems}
                        </ul>
                    </div>
