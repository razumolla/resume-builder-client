...
const AddPersonalDevBlog = () => {
                    ...
                    fetch('http://localhost:5000/personalDevBlog', {
                        ...
                        .then(insertedBlog => {
                            if (insertedBlog.insertedId) {
                                toast.success('Personal development Blog added successfully')
                                reset();
                            }
                            else {
    ...
    return (
        <div className='mt-2'>
            <h1 className='text-2xl font-semibold mb-4'> Personal Development Blog </h1>
...
export default AddPersonalDevBlog;