...
const AddCoverLetterBlog = () => {
                    ...
                    fetch('http://localhost:5000/coverLetterBlog', {
                        ...
                        .then(insertedBlog => {
                            if (insertedBlog.insertedId) {
                                toast.success('Cover Letter Blog added successfully')
                                reset();
                            }
                            else {
    ...
    return (
        <div className='mt-2'>
            <h1 className='text-2xl'> Add a New Cover Letter Blog </h1>
...
export default AddCoverLetterBlog;