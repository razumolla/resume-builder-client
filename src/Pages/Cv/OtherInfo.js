    ...
    return (
        <div>
            ...
            <div className='m-2 flex flex-col justify-center items-center'>
                ...
                <div className='p-2'>
                    <input type="text" placeholder="Skill 1" className="input input-bordered input-primary w-80 max-w-xs peer dark:text-black" value={formData.skillOne} onChange={(e) => setFormData({ ...formData, skillOne: e.target.value })} required />
                ...
                <div className='p-2'>
                    <input type="text" placeholder="Skill 2" className="input input-bordered input-primary w-80 max-w-xs peer dark:text-black" value={formData.skillTwo} onChange={(e) => setFormData({ ...formData, skillTwo: e.target.value })} required />
                ...
                <div className='p-2'>
                    ...
                    <textarea className="textarea textarea-primary dark:text-black" style={{ width: '20rem !important' }} placeholder="Write about yourself" value={formData.summary} onChange={(e) => setFormData({ ...formData, summary: e.target.value })}></textarea>
