    ...
    return (
        <div>
            ...
            <div className='m-2'>
                ...
                <div className='grid grid-cols-1 gap-3 p-2'>
                    <input type="text" placeholder="University/College Name" class="input input-bordered input-primary w-full max-w-xs" value={formData.university} onChange={(e) => setFormData({ ...formData, university: e.target.value })} required />
                </div>
