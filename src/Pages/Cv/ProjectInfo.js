        ...
        <div>
            ...
            <div className="m-2">
                <div className='grid grid-cols-1 gap-3 p-2'>
                    <input type="text" placeholder="Project Name" class="input input-bordered input-primary w-full max-w-xs" value={formData.projectName} onChange={(e) => setFormData({ ...formData, projectName: e.target.value })} required />

                    <input type="text" placeholder="Project Link" class="input input-bordered input-primary w-full max-w-xs" value={formData.projectLink} onChange={(e) => setFormData({ ...formData, projectLink: e.target.value })} required />
