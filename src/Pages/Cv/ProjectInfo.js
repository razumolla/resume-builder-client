    ...
    return (
        <div>
            ...
            <div className="m-2 flex flex-col justify-center items-center gap-3">
                ...
                <div className='p-2'>
                    <input type="text" placeholder="Project Name" className="input input-bordered input-primary w-80 peer dark:text-black" value={formData.projectName} onChange={(e) => setFormData({ ...formData, projectName: e.target.value })} required />
                ...
                <div className='p-2'>
                    <input type="text" placeholder="Project Link" className="input input-bordered input-primary w-80 peer dark:text-black" value={formData.projectLink} onChange={(e) => setFormData({ ...formData, projectLink: e.target.value })} required />
                ...
                <div className=''>
                    <textarea className="textarea textarea-primary peer dark:text-black"
                        style={
