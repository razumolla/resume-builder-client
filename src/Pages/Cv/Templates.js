...
const Templates = () => {
    ...
    return (
        <div className='mt-2'>
            ...
            <div className="hero min-h-screen w-4/5 px-10 mx-auto ">
                <div className="hero-content flex-col lg:flex-row-reverse gap-10">
                    <img src={cvBanner} className="max-w-64 md:max-w-md rounded-lg animate__animated animate__fadeInUp animate__delay-.9s" />
                    <div className='w-48 md:w-full lg:text-left text-center'>
                        <h1 className="text-5xl font-bold text-primary animate__animated animate__fadeInUp animate__delay-fast">Create Your CV</h1>
            ...
            <div className='grid sm:grid-cols-1 lg:grid-cols-3 p-8 my-8 '>
                {
