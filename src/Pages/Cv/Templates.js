...
const Templates = () => {
    ...
    return (
        <div className='mt-10'>
            <div className="hero h-5/6 bg-neutral shadow-xl rounded">
                <div className="hero-content flex-col lg:flex-row gap-10">
                    ...
                    <div>
                        ...
                        <p className="py-6 text-2xl text-sky-700">Our CV templates are designed with your success of mind.You can use them free.Some of them are premium.</p>
                    </div>
                </div>
            </div>
