        ...
        <div className="hero min-h-screen px-10 ">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className='lg:text-left text-center'>
                    <h1 className="text-5xl font-bold text-secondary animate__animated animate__zoomIn">Create Your Resume</h1>
                    <p className="py-6 animate__animated  animate__lightSpeedInLeft">A resume is a formal document that a job applicant creates to itemize their qualifications for a position. </p>
