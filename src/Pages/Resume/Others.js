    ...
    return (
        <div className='text-center'>
            <ul className="steps bg-base-300   
                ...
                <li className="step step-primary lg:mx-2" > <p className='text-sm sm:text-xm'>PERSONAL</p> </li>
                <li className="step step-primary lg:mx-2"><p className='text-sm sm:text-xm'>EDUCATION</p> </li>
                <li className="step step-primary lg:mx-2"> <p className='text-sm sm:text-xm'>PROJECTS</p> </li>
                <li className="step  step-primary lg:mx-2"> <p className='text-sm sm:text-xm'>Others</p> </li>
            </ul>
