                    ...
                    <div className="card-body grid sm:grid-cols-1 lg:grid-cols-3 my-5 gap-10">
                        ...
                        <div className="card bg-white  shadow-xl mb-5 dark:bg-cyan-900">
                            <div className="card-body">
                                ...
                                <p>$<span>19.99</span></p>
                                <Link to="/paymentCardOne"><button className="btn btn-xs btn-outline bg-secondary text-white mt-5">Upgrate Now</button></Link>
                            </div>
                        </div>
                        <div className="card bg-white  shadow-xl mb-5 dark:bg-cyan-900">
                            <div className="card-body">
                                ...
                                <Link to="/paymentCardTwo"><button className="btn btn-xs btn-outline bg-secondary text-white mt-5">Upgrate Now</button></Link>
                            </div>
                        </div>
                        <div className="card bg-white  shadow-xl mb-5 dark:bg-cyan-900">
                            <div className="card-body">
                                ...
                                <Link to="/paymentCardThree"><button className="btn btn-xs btn-outline bg-secondary text-white mt-5">Upgrate Now</button></Link>
                            </div>
                        </div>
